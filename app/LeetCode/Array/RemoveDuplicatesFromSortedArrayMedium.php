...
class RemoveDuplicatesFromSortedArrayMedium implements BaseSolvedProblemsInterface
{
    ...
    {
        return new ResolutionResponse(result: $this->removeDuplicates($params['nums']));
    }
